...
const About = ({ handleShowLogin, handleShowSignup, handleCloseAuth }) => {
  ...
  const team = [
    {
      ...
      role: "Head Chef",
      image:
        "https://images.unsplash.com/photo-1594824020552-bb8aac2aa29d?w=300&h=300&fit=crop&crop=face",
    },
    {
      name: "Mike Chen",
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1494790108755-2616b95ab644?w=300&h=300&fit=crop&crop=face",
    },
  ];
          ...
          <div className="bg-gradient-to-r from-orange-50 to-orange-100 dark:from-gray-800 dark:to-gray-700 py-16 px-6 transition-colors duration-300">
            <div className="max-w-6xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed transition-colors duration-300">
                We're passionate about delivering fresh, delicious meals right
                to your doorstep. Serving California with love, one meal at a
                time.
              </p>
            </div>
          </div>
          ...
          <div className="py-16 px-6 bg-gray-50 dark:bg-gray-800 transition-colors duration-300">
            <div className="max-w-6xl mx-auto">
              <div className="grid md:grid-cols-2 gap-12 items-center">
                <div>
                  <h2 className="text-3xl font-bold text-gray-800 dark:text-gray-100 mb-6 transition-colors duration-300">
                    Our Story
                  </h2>
                  <p className="text-gray-600 dark:text-gray-300 mb-4 leading-relaxed transition-colors duration-300">
                    Founded in the heart of California, our food delivery
                    service was born from a simple idea: everyone deserves
                    access to fresh, delicious meals without the hassle of
                    cooking or leaving home.
                  </p>
                  <p className="text-gray-600 dark:text-gray-300 mb-4 leading-relaxed transition-colors duration-300">
                    What started as a small local operation has grown into a
                    trusted name across California, serving thousands of happy
                    customers daily. We partner with the best local restaurants
                  ...
                  <p className="text-gray-600 dark:text-gray-300 leading-relaxed transition-colors duration-300">
                    ...
                    drives everything we do. From our kitchen to your table, we
                    ensure every meal is prepared with care and delivered with a
                    smile.
                  </p>
                </div>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto transition-colors duration-300">
                  We're committed to providing you with the best food delivery
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                {features.map((feature, index) => (
                  <div
                    key={index}
                    className="text-center p-6 rounded-xl hover:shadow-lg dark:hover:shadow-2xl transition-all duration-300 bg-white dark:bg-gray-800 border border-transparent dark:border-gray-700"
                  >
          ...
          <div className="py-16 px-6 bg-gray-50 dark:bg-gray-800 transition-colors duration-300">
            <div className="max-w-6xl mx-auto text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto transition-colors duration-300">
                We proudly serve customers across California with our fast and
              ...
              <div className="bg-white dark:bg-gray-700 rounded-xl p-8 shadow-sm dark:shadow-xl transition-colors duration-300">
                <div className="grid md:grid-cols-3 gap-8">
                  <div className="text-center">
                    <div className="text-orange-500 dark:text-orange-400 text-2xl font-bold mb-2 transition-colors duration-300">
                      📍
                    </div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300 text-sm transition-colors duration-300">
                      Serving all major cities across California
                    </p>
                  </div>
                  <div className="text-center">
                    <div className="text-orange-500 dark:text-orange-400 text-2xl font-bold mb-2 transition-colors duration-300">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 text-sm transition-colors duration-300">
                      Within 15KM radius from our locations
                    </p>
                  </div>
                  <div className="text-center">
                    <div className="text-orange-500 dark:text-orange-400 text-2xl font-bold mb-2 transition-colors duration-300">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 text-sm transition-colors duration-300">
                      Your order arrives in 25-30 minutes
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="py-16 px-6 bg-white dark:bg-gray-900 transition-colors duration-300">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                ...
                <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto transition-colors duration-300">
                  The passionate people behind your favorite food delivery
                  experience
                </p>
              </div>
              <div className="grid md:grid-cols-3 gap-8">
                {team.map((member, index) => (
                  <div
                    key={index}
                    className="text-center p-6 rounded-xl bg-white dark:bg-gray-800 shadow-sm dark:shadow-xl hover:shadow-lg dark:hover:shadow-2xl transition-all duration-300"
                  >
                    <img
                      src={member.image}
                      alt={member.name}
                    ...
                    <p className="text-orange-500 dark:text-orange-400 font-medium transition-colors duration-300">
                      {member.role}
                    </p>
                  </div>
                ))}
          ...
          <div className="py-16 px-6 bg-gradient-to-r from-orange-500 to-orange-600 dark:from-orange-600 dark:to-orange-700 transition-colors duration-300">
            <div className="max-w-4xl mx-auto text-center text-white">
              ...
              <p className="text-xl leading-relaxed mb-8">
                To make delicious, fresh food accessible to everyone in
                California through our fast, reliable, and affordable delivery
                service. We believe great food brings people together and
