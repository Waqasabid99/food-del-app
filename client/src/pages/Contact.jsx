...
const Contact = ({ handleShowLogin, handleShowSignup, handleCloseAuth }) => {
  ...
  const faqItems = [
    {
      ...
      answer:
        "We deliver across California with free delivery within 15KM of our locations. Delivery fees may apply for longer distances.",
    },
    {
      question: "How long does delivery take?",
      answer:
        "Our standard delivery time is 25-30 minutes. During peak hours, it may take up to 45 minutes.",
    },
    {
      question: "Can I track my order?",
      answer:
        "Yes! Once your order is confirmed, you'll receive a tracking link to monitor your delivery in real-time.",
    },
    {
          ...
          <div className="bg-gradient-to-r from-orange-50 to-orange-100 dark:from-gray-800 dark:to-gray-700 py-16 px-6 transition-colors duration-300">
            <div className="max-w-6xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed transition-colors duration-300">
                ...
                here to help! Reach out to us anytime and we'll get back to you
                as soon as possible.
              </p>
            </div>
          </div>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                {contactInfo.map((info, index) => (
                  <div
                    key={index}
                    className="text-center p-6 bg-gray-50 dark:bg-gray-800 rounded-xl hover:shadow-lg dark:hover:shadow-2xl transition-all duration-300"
                  >
                    <div className="text-4xl mb-4">{info.icon}</div>
                    <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-2 transition-colors duration-300">
                      {info.title}
                    </h3>
                    <p className="text-orange-500 dark:text-orange-400 font-medium mb-2 transition-colors duration-300">
                      {info.info}
                    </p>
                    ...
                    <div className="bg-gray-100 dark:bg-gray-800 rounded-lg h-48 flex items-center justify-center mb-4 transition-colors duration-300">
                      <div className="text-center text-gray-500 dark:text-gray-400">
                        ...
                        <p className="text-sm transition-colors duration-300">
                          123 Food Street, Los Angeles, CA
                        </p>
                      </div>
                    </div>
                    <div className="space-y-2 text-sm">
                      <p className="text-gray-600 dark:text-gray-300 transition-colors duration-300">
                        <span className="font-medium">Address:</span> 123 Food
                        Street, Los Angeles, CA 90210
                      </p>
                      <p className="text-gray-600 dark:text-gray-300 transition-colors duration-300">
                        <span className="font-medium">Parking:</span> Free
                        parking available
                      </p>
                      <p className="text-gray-600 dark:text-gray-300 transition-colors duration-300">
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-6">
                {faqItems.map((faq, index) => (
                  ...
                  >
                    <h3 className="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-3 transition-colors duration-300">
                      {faq.question}
                    </h3>
